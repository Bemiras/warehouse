...
return array(
    ...
    "required_with"        => ":attribute jest wymagane, gdy :values są zdefiniowane.",
    "required_with_all"    => ":attribute jest wymagane, gdy :values są zdefiniowane.",
    "required_without"     => ":attribute jest wymagane, gdy :values nie są zdefiniowane.",
    "required_without_all" => ":attribute jest wymagane, gdy żadne z :values nie są zdefiniowane.",
